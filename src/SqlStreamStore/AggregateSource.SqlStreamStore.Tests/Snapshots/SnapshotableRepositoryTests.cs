//using System;
//using AggregateSource.SqlStreamStore.Framework;
//using AggregateSource.SqlStreamStore.Framework.Snapshots;
//using NEventStore;
//using NUnit.Framework;

//namespace AggregateSource.SqlStreamStore.Snapshots
//{
...
//                    () => new SnapshotableRepository<SnapshotableAggregateRootEntityStub>(null, _unitOfWork));
//            }
...
//            {
//                Assert.Throws<ArgumentNullException>(
//                    () => new SnapshotableRepository<SnapshotableAggregateRootEntityStub>(_factory, null));
//            }
...
//            {
//                Assert.Throws<ArgumentNullException>(
//                    () => new SnapshotableRepository<SnapshotableAggregateRootEntityStub>(_factory, _unitOfWork));
//            }
//        }
